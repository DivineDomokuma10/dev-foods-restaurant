...
const About = () => {
  return (
    ...
    >
      <article className="w-full min-h-[85vh] flex flex-col items-center py-5 bg-black backdrop-blur-md backdrop-filter bg-opacity-90 justify-center space-y-10 sm:p-0 sm:space-y-14 md:min-h-[93vh] md:justify-evenly">
        <motion.h1
        ...
        <motion.div className="flex flex-col space-y-10 lg:flex-row sm:space-y-10 lg:space-y-0">
          <motion.p
